...
const ONNXDeployManual: React.FC<Props> = ({ service }) => {
    ...
    <div className='rounded shadow px-10 py-10 mt-5 bg-white'>
      <div className='flex gap-8'>
        {/* <div className='flex-1'>
          <div className=''>
            <div className='font-bold'>Let's deploy your ONNX model</div>
        ...
        <div className='flex-1'>
          ...
          <div className='text-gray-600 my-3'>Upload your `.onnx` file here to deploy.</div>

          <DeployZone service={service} title='Drag and drop the exported ONNX model here'/>
        </div>
      </div>
    </div>
  )
...
export default ONNXDeployManual